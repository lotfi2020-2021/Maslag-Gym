...
class CommentairesController extends AbstractController
{
     ...
     */
    public function new(Request $request,CommentairesRepository $commentairesRepository,PaginatorInterface $paginator ): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('commentaires_new', [], Response::HTTP_SEE_OTHER);
        }
        $donnees =$this->getDoctrine()->getRepository(Commentaires::class)->findAll();
